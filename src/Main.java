...
public class Main {
	...
	public static void main(String[] args) {
		...
		analyzeFromUser(scanner, test, training, k);
		scanner.close();
	}

	public static void analyzeFromUser(Scanner scanner, String[][] test, String[][] training, int k) {
	...
	public static void analyzeFromFile(String[][] test, String[][] training, int k) {
		...
		System.out.println("Poprawnie zakwalifikowane przykłady: " + succeses);
		System.out.println("Liczba porównanych kwiatów: " + comparisons);
		double percentage = (float) succeses / (float) comparisons * 100;
